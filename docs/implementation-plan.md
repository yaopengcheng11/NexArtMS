...
> 需求更新（2026-09-25）：混剪视频的人物可由不同演员共同扮演一个成片角色，且可选择不制作可见场景。新产品流程见 [混剪素材：角色归并与可选场景](mixed-cut-workflow.md)。本文以下“单一场景优先”“原片人物一对一”“先通过场景才能确认角色”等内容仅适用于原 JWM 样片计划，不能作为新需求的通用门槛。
